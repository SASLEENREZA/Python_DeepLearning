with open(r'C:\Users\rezas\PycharmProjects\LAB-1\venv\f2.txt') as f2:
    f2_text = f2.read()
...
with open(r'C:\Users\rezas\PycharmProjects\LAB-1\venv\f1.txt', "r") as f:
    for line in f:
        tmp.append(line)

# Now open file1 in write mode so that the content present in file1 can be over written
fout = open(r'C:\Users\rezas\PycharmProjects\LAB-1\venv\f1.txt', "w")
for line in tmp:
