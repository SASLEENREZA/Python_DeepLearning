...
#Sentence tokenization and work tokenization
...
print("________Porter stemming output________ \n")
for p in wordtokens:
    print(pStemmer.stem(str(p)))

#lancasters Stemmer
lStemmer=LancasterStemmer()
print("________Lancaster stemming output__________\n")
for t in wordtokens:
    print(lStemmer.stem(str(t)))

#Snowball Stemmer
sStemmer = SnowballStemmer('english')
print("__________Snowball stemming output___________ \n")
for s in wordtokens:
